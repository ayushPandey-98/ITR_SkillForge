...
function Home() {
  ...
  return (
    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <span className='lg:text-[70px] absolute md:text-[40px] lg:top-[10%] top-[15%] w-full flex flex-wrap items-center justify-center text-white font-bold text-[20px]'>
  Grow Your&nbsp;
  <span className='text-[#38D2CA]'>Skiils</span>
  &nbsp;to Advance
</span>
