...
function Cardspage() {
  ...
  return (
    ...
    '>
           ...
           <button className=' absolute right-[9%] bottom-2 px-[20px] py-[10px] border-2 lg:border-white border-black bg-black lg:text-white text-white font-semibold rounded-[10px] text-[18px]  flex gap-2 cursor-pointer' onClick={()=>navigate("/allcourses")}>View all Courses <SiViaplay className='w-[30px] h-[30px] text-[#38D2CA] lg:text-[#38D2CA] bg-black' /></button>
            </div>
  )
}
